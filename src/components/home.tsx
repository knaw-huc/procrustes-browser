        ...
        <div>
            ...
            <div className="hcContentContainer hcMarginBottom5">
                ...
                <h2>Timbuctoo datasets</h2>
                    ...
                    <div className="dsOptions"><div className="dsOption">Browse data</div><div className="dsOption" onClick={() => {goToPage('metadata', 'u33707283d426f900d4d33707283d426f900d4d0d__delegates')}}>View metadata</div> </div>
                    <div className="resultShelfmark">Abbreviated delegates</div>
                    <div className="resultDescription">Excel sheet van Rik</div>
                    <div className="dsOptions"><div className="dsOption">Browse data</div><div className="dsOption" onClick={() => {goToPage('metadata', 'u33707283d426f900d4d33707283d426f900d4d0d__abbreviated_delegates')}}>View metadata</div></div>
                </div>
            </div>
            <Footer/>
        </div>
